...
- (void) startServer:(CDVInvokedUrlCommand *)command
{
	...
	if (peripheralManager == nil){
		iasAdded = false;
		peripheralManager = [[CBPeripheralManager alloc] initWithDelegate:self queue:nil options:@{ CBPeripheralManagerOptionRestoreIdentifierKey:pluginName, CBPeripheralManagerOptionShowPowerAlertKey:@NO/*[NSNumber numberWithBool:NO]*/ }]; // Added 2017-03-17
