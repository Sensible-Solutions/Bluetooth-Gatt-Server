...
-(void)peripheralManagerDidUpdateState:(CBPeripheralManager *)peripheral
{
    switch ([peripheral state]) {
        ...
        case CBPeripheralManagerStatePoweredOn: {
			...
			CBMutableCharacteristic *characteristic4 = [[CBMutableCharacteristic alloc]initWithType:[CBUUID UUIDWithString:@"2a44"] properties:CBCharacteristicPropertyWrite value:nil permissions:CBAttributePermissionsWritable];
