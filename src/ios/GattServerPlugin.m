...
//- (void)alarm:(CDVInvokedUrlCommand *)command			// Used for manually calling and debuging instead of row above
{
	...
	if (alarmDate != nil){
		...
		UIAlertView *debugAlert = [[UIAlertView alloc] initWithTitle: @"Debug alarmInterval" message:alarmInterval delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
		[debugAlert show];
