...
- (void) startServer:(CDVInvokedUrlCommand *)command
{
	...
	if (peripheralManager == nil){
		...
		peripheralManager = [[CBPeripheralManager alloc] initWithDelegate:self queue:nil options:@{ CBPeripheralManagerOptionRestoreIdentifierKey:pluginName, CBPeripheralManagerOptionShowPowerAlertKey:[NSNumber numberWithBool:YES] }];
